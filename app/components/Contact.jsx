...
export default function Contact() {
  return (
    <>
      <div id="contact" className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 mt-10 px-20 sm:text-left pb-16  pt-10 bg-slate-100">
        <div>
        <h1 href="/" className="text-green-500 font-bold text-lg">
              <span className="bg-green-500 text-white p-1 rounded">F</span>OODI
            </h1>
          <p className="pr-16 mt-4 text-md  text-gray-500">
      ...
      <div className="flex justify-center bg-slate-100 pt-2 border-t-2 pb-6">
